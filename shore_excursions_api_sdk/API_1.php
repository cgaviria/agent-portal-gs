...
class Shore_Excursions_API {
	...
	public function callAPI($method, $url, $data, $api_key, $token = null)
	{
		$curl = curl_init();
	...
	{
		$get_data = $this->callAPI('POST', $this->_url . 'create_booking', json_encode($booking_array), $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return ($response);
	}
	...
	{
		$get_data = $this->callAPI('POST', $this->_url . 'edit_booking', json_encode($data_array), $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($response);
	}
	...
	{
		$get_data = $this->callAPI('GET', $this->_url . 'read_booking?id='.$id, false, $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($get_data);
	}
	...
	{
		$get_data = $this->callAPI('POST', $this->_url . 'create_group', json_encode($data_array), $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($response);
	}
	...
	{
		$get_data = $this->callAPI('POST', $this->_url . 'edit_group', json_encode($data_array), $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($response);
	}
	...
	{
		$get_data = $this->callAPI('GET', $this->_url . 'read_group?id='.$id, false, $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($get_data);
	}
	...
	{
		$get_data = $this->callAPI('GET', $this->_url . 'delete_group?id='.$id, false, $this->_api_key, $this->_token);
		$response = json_decode($get_data, true);
		return($get_data);
	}
}
