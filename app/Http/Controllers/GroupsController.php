...
class GroupsController extends Controller
{
    ...
    /**
     * Get the table structure of group table.
     *
     * @return Response
     */
    ...
    public function getData(Request $request)
    {
        ...
        if ($user_check) {
            ...
            return $datatables->eloquent($groups)->editColumn('duration', function ($group){
  ...
  /**
   * Get monthly group count for dashboard
   *
   * @return Response
   */
   ...
   /**
     * Shows the bookings page depending on the group
     *
     * @return Response
     */
    ...
    /**
     * Shows the customer details of the particular group
     *
     * @return Response
     */
